...
#ifndef RTIBOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
#define RTIBOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
...
#   define RTIBOOST_AUX_CLASS_SEQUENCE_TAG_SPEC(has_tag, has_begin, result_type) \
...
RTIBOOST_AUX_CLASS_SEQUENCE_TAG_SPEC(true, true, typename Sequence::tag)
RTIBOOST_AUX_CLASS_SEQUENCE_TAG_SPEC(true, false, typename Sequence::tag)
RTIBOOST_AUX_CLASS_SEQUENCE_TAG_SPEC(false, true, nested_begin_end_tag)
RTIBOOST_AUX_CLASS_SEQUENCE_TAG_SPEC(false, false, non_sequence_tag)

#   undef RTIBOOST_AUX_CLASS_SEQUENCE_TAG_SPEC
...
struct sequence_tag
    : aux::sequence_tag_impl<
          ::rtiboost::mpl::aux::has_tag<Sequence>::value
        , ::rtiboost::mpl::aux::has_begin<Sequence>::value
...
RTIBOOST_MPL_AUX_NA_SPEC(1, sequence_tag)

}}

#endif // RTIBOOST_MPL_SEQUENCE_TAG_HPP_INCLUDED
