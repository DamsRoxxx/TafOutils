 ...
 */
#ifndef RTIBOOST_SMART_PTR_DETAIL_ARRAY_ALLOCATOR_HPP
#define RTIBOOST_SMART_PTR_DETAIL_ARRAY_ALLOCATOR_HPP

#include <rtiboost/align/align.hpp>
#include <rtiboost/smart_ptr/detail/array_traits.hpp>
#include <rtiboost/smart_ptr/detail/array_utility.hpp>
    ...
    namespace detail {
        ...
        public:
            ...
            pointer allocate(size_type count, const_void_pointer = 0) {
                enum {
                    M = rtiboost::alignment_of<type>::value
                };
                ...
                (void)rtiboost::alignment::align(M, n2, p2, n3);
