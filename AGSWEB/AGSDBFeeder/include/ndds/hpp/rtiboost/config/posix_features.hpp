...
#  if defined(RTIBOOST_HAS_UNISTD_H)
#     include <unistd.h>
...
#     if defined(_POSIX_THREADS) && (_POSIX_THREADS+0 >= 0) && !defined(RTIBOOST_HAS_WINTHREADS) && !defined(RTIBOOST_HAS_MPTASKS)
#        define RTIBOOST_HAS_PTHREADS
#     endif

      // RTIBOOST_HAS_NANOSLEEP:
...
#     endif
      ...
      // RTIBOOST_HAS_GETTIMEOFDAY:
      // RTIBOOST_HAS_PTHREAD_MUTEXATTR_SETTYPE:
