...
#   define RTIBOOST_COMPILER_CONFIG "rtiboost/config/compiler/xlcpp.hpp"
...
//
#include "rtiboost/config/compiler/gcc_xml.hpp"
#include "rtiboost/config/compiler/cray.hpp"
#include "rtiboost/config/compiler/comeau.hpp"
#include "rtiboost/config/compiler/pathscale.hpp"
#include "rtiboost/config/compiler/intel.hpp"
#include "rtiboost/config/compiler/clang.hpp"
#include "rtiboost/config/compiler/digitalmars.hpp"
#include "rtiboost/config/compiler/gcc.hpp"
#include "rtiboost/config/compiler/kai.hpp"
#include "rtiboost/config/compiler/sgi_mipspro.hpp"
#include "rtiboost/config/compiler/compaq_cxx.hpp"
#include "rtiboost/config/compiler/greenhills.hpp"
#include "rtiboost/config/compiler/codegear.hpp"
#include "rtiboost/config/compiler/borland.hpp"
#include "rtiboost/config/compiler/metrowerks.hpp"
#include "rtiboost/config/compiler/sunpro_cc.hpp"
#include "rtiboost/config/compiler/hp_acc.hpp"
#include "rtiboost/config/compiler/mpw.hpp"
#include "rtiboost/config/compiler/vacpp.hpp"
#include "rtiboost/config/compiler/pgi.hpp"
