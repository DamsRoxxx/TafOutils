...
#ifndef RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_VOLATILE_HOLT_2004_0828
#define RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_VOLATILE_HOLT_2004_0828
...
namespace rtiboost {
    namespace detail {
        ...
        struct remove_volatile_impl_typeof<true,false,false,true> {
            ...
            struct inner {
                ...
                static msvc_register_type<T,ID> test(...);
                RTIBOOST_STATIC_CONSTANT(unsigned,register_test=sizeof(test( (void(*)(T))(NULL) ) ));
                typedef typename msvc_extract_type<ID>::id2type::type type;
            };
            template<typename T>
            struct transform_type {
        ...
        struct remove_volatile_impl_typeof<false,true,false,true> {
            template<typename T,typename ID>
            struct inner {
                RTIBOOST_STATIC_CONSTANT(unsigned,value=(sizeof(T)/sizeof((*((T*)NULL))[0])));
    ...
    struct remove_volatile {
        typedef rtiboost::detail::remove_volatile_impl_typeof<
        ...
        typedef typename 
            ...
            >::type
        type;
        RTIBOOST_MPL_AUX_LAMBDA_SUPPORT(1,remove_volatile,T)
    };
}//namespace rtiboost

#endif //RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_VOLATILE_HOLT_2004_0828
