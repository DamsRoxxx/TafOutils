...
#if !defined(RTIBOOST_NO_IS_ABSTRACT)
...
#endif
#if !defined(RTIBOOST_NO_SFINAE_EXPR) && !defined(RTIBOOST_NO_CXX11_RVALUE_REFERENCES)
...
#if !defined(RTIBOOST_NO_SFINAE_EXPR) && !defined(RTIBOOST_NO_CXX11_RVALUE_REFERENCES) && !(defined(RTIBOOST_GCC) && (RTIBOOST_GCC < 40700))

   // This is a C++11 conforming version, place this first and use it wherever possible:

#  define RTIBOOST_TT_CXX11_IS_CONVERTIBLE
   ...
   template<typename From, typename To, bool b = or_helper<rtiboost::is_void<From>, rtiboost::is_function<To>, rtiboost::is_array<To> >::value>
   ...
   class is_convertible_basic_impl<From, To, false>
   {
      ...
      static decltype(test_aux<To1>(rtiboost::declval<From1>()), one()) test(int);
...
{
    enum { 
       value = ( ::rtiboost::detail::is_convertible_basic_impl<From,To>::value && ! ::rtiboost::is_array<To>::value && ! ::rtiboost::is_function<To>::value) 
    };
};
...
struct is_convertible_impl
{
   RTIBOOST_STATIC_CONSTANT(bool, value = ( ::rtiboost::detail::is_convertible_basic_impl<From, To>::value && !::rtiboost::is_array<To>::value && !::rtiboost::is_function<To>::value));
};
#endif
...
#if !defined(RTIBOOST_NO_IS_ABSTRACT) && !defined(RTIBOOST_TT_CXX11_IS_CONVERTIBLE)
...
template <class From, class To> 
struct is_convertible : public integral_constant<bool, ::rtiboost::detail::is_convertible_impl_dispatch<From, To>::value> {};

#else

template <class From, class To>
struct is_convertible : public integral_constant<bool, RTIBOOST_IS_CONVERTIBLE(From, To)> {};
