#ifndef RTIBOOST_TYPE_TRAITS_DETAIL_COMMON_ARITHMETIC_TYPE_HPP_INCLUDED
#define RTIBOOST_TYPE_TRAITS_DETAIL_COMMON_ARITHMETIC_TYPE_HPP_INCLUDED
...
{
    typedef rtiboost::long_long_type type;
...
{
    typedef rtiboost::ulong_long_type type;
...
#if !defined( RTIBOOST_NO_CXX11_CHAR16_T )
...
#if !defined( RTIBOOST_NO_CXX11_CHAR32_T )
...
#if defined( RTIBOOST_HAS_INT128 )

template<> struct arithmetic_type<19>
{
    typedef rtiboost::int128_type type;
    typedef char (&result_type) [19];
};

template<> struct arithmetic_type<20>
{
    typedef rtiboost::uint128_type type;
...
#endif // #ifndef RTIBOOST_TYPE_TRAITS_DETAIL_COMMON_ARITHMETIC_TYPE_HPP_INCLUDED
