...
_pkg_config = {
    ...
    'default_mod_dir':  '/usr/lib64/python2.6/site-packages',
    'default_sip_dir':  '/usr/share/sip',
    'platform':         'linux-g++',
    'py_conf_inc_dir':  '/usr/include/python2.6',
    'py_inc_dir':       '/usr/include/python2.6',
    'py_lib_dir':       '/usr/lib64/python2.6/config',
    'py_version':       0x020602,
    'sip_bin':          '/usr/bin/sip',
    'sip_config_args':  '-d /usr/lib64/python2.6/site-packages CXXFLAGS=-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -m64 -mtune=generic CFLAGS=-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -m64 -mtune=generic',
    'sip_inc_dir':      '/usr/include/python2.6',
    'sip_mod_dir':      '/usr/lib64/python2.6/site-packages',
