...
#ifndef RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_CONST_HOLT_2004_0828
#define RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_CONST_HOLT_2004_0828
...
namespace rtiboost {
    ...
    template<typename T>
    struct remove_const {
        typedef rtiboost::detail::remove_const_impl_typeof<
        ...
        typedef typename 
            ...
            >::type
        type;
        RTIBOOST_MPL_AUX_LAMBDA_SUPPORT(1,remove_const,T)
    };
}//namespace rtiboost

#endif //RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_CONST_HOLT_2004_0828
