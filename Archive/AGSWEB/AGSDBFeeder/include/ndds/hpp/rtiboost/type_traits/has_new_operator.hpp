...
#     define RTIBOOST_TT_AUX_MACRO_NEW_DEFINED
...
template <class T> struct has_new_operator : public integral_constant<bool, ::rtiboost::detail::has_new_operator_impl<T>::value>{};

} // namespace rtiboost

#if defined(RTIBOOST_TT_AUX_MACRO_NEW_DEFINED)
