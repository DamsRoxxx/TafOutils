...
#ifndef RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_EXTENT_HOLT_2004_0827
#define RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_EXTENT_HOLT_2004_0827
...
namespace rtiboost {
    ...
    struct remove_extent {
        typedef typename rtiboost::detail::remove_extent_impl_typeof<
            rtiboost::is_array<T>::value                
        >::template inner<T,remove_extent<T> >::type type;
        RTIBOOST_MPL_AUX_LAMBDA_SUPPORT(1,remove_extent,T)
    };
} //namespace rtiboost
