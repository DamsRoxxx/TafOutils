...
#ifndef RTIBOOST_TT_ICE_HPP_INCLUDED
#define RTIBOOST_TT_ICE_HPP_INCLUDED
...
#include <rtiboost/type_traits/detail/ice_eq.hpp>

#endif // RTIBOOST_TT_ICE_HPP_INCLUDED
