 ...
 *
 * struct rtiboost::common_type<T,U>
 *
...
#ifndef RTIBOOST_TYPE_TRAITS_DETAIL_COMMON_TYPE_IMP_HPP
#define RTIBOOST_TYPE_TRAITS_DETAIL_COMMON_TYPE_IMP_HPP
...
#include <rtiboost/mpl/contains.hpp>
#include <rtiboost/mpl/copy.hpp>
...
#include <rtiboost/mpl/or.hpp>
#include <rtiboost/mpl/placeholders.hpp>
#include <rtiboost/mpl/push_back.hpp>
#include <rtiboost/mpl/size.hpp>
#include <rtiboost/mpl/vector/vector0.hpp>
...
RTIBOOST_MPL_ASSERT_RELATION( sizeof( yes_type ), ==, 1 );
RTIBOOST_MPL_ASSERT_RELATION( sizeof( no_type ), ==, 2 );
...
struct common_type_impl
    : public common_type_dispatch_on_rvalueness<T,U, sizeof( ::rtiboost::detail_type_traits_common_type::rvalue_test(
...
#endif // RTIBOOST_TYPE_TRAITS_DETAIL_COMMON_TYPE_HPP
