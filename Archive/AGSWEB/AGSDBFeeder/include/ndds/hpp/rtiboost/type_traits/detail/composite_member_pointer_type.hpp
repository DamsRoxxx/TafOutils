#ifndef RTIBOOST_TYPE_TRAITS_DETAIL_COMPOSITE_MEMBER_POINTER_TYPE_HPP_INCLUDED
#define RTIBOOST_TYPE_TRAITS_DETAIL_COMPOSITE_MEMBER_POINTER_TYPE_HPP_INCLUDED
...
template<class C1, class C2> struct common_member_class
{
    typedef typename rtiboost::conditional<
        ...
        rtiboost::is_base_of<C1, C2>::value,
        C2,
        typename rtiboost::conditional<rtiboost::is_base_of<C2, C1>::value, C1, void>::type
...
private:
    ...
    typedef typename rtiboost::remove_pointer<CPT>::type CT;
...
#endif // #ifndef RTIBOOST_TYPE_TRAITS_DETAIL_COMPOSITE_MEMBER_POINTER_TYPE_HPP_INCLUDED
