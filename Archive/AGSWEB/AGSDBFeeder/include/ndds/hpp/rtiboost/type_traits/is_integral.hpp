...
template<> struct is_integral< ::rtiboost::ulong_long_type> : public true_type{};
template<> struct is_integral< ::rtiboost::long_long_type> : public true_type{};
...
template<> struct is_integral<rtiboost::int128_type> : public true_type{};
template<> struct is_integral<rtiboost::uint128_type> : public true_type{};
#endif
