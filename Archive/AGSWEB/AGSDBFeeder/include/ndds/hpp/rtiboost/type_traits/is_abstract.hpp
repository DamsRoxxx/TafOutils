...
template <class T> struct is_abstract : public integral_constant<bool, ::rtiboost::detail::is_abstract_imp<T>::value> {};
#else
template <class T> struct is_abstract : public integral_constant<bool, ::rtiboost::detail::is_polymorphic_imp<T>::value> {};
#endif
