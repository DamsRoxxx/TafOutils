 ...
 */
#ifndef RTIBOOST_SMART_PTR_DETAIL_ARRAY_COUNT_IMPL_HPP
#define RTIBOOST_SMART_PTR_DETAIL_ARRAY_COUNT_IMPL_HPP

#include <rtiboost/smart_ptr/detail/array_allocator.hpp>
