#ifndef RTIBOOST_SMART_PTR_DETAIL_SP_FORWARD_HPP_INCLUDED
#define RTIBOOST_SMART_PTR_DETAIL_SP_FORWARD_HPP_INCLUDED
...
#if defined( RTIBOOST_GCC ) && __GNUC__ * 100 + __GNUC_MINOR__ <= 404
...
template< class T > T&& sp_forward( T && t ) RTIBOOST_NOEXCEPT
{
    return t;
}
...
#endif  // #ifndef RTIBOOST_SMART_PTR_DETAIL_SP_FORWARD_HPP_INCLUDED
