...
#ifndef RTIBOOST_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
#define RTIBOOST_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
...
struct push_front_impl
{
    template< typename Sequence, typename T > struct apply
    {
        ...
        RTIBOOST_MPL_ASSERT_MSG(
              ( rtiboost::is_same< T, has_push_front_arg >::value )
...
RTIBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(2, push_front_impl)
RTIBOOST_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(1, has_push_front_impl)

}}

#endif // RTIBOOST_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
