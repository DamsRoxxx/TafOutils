...
#ifndef RTIBOOST_MPL_AUX778076_ADVANCE_BACKWARD_HPP_INCLUDED
#define RTIBOOST_MPL_AUX778076_ADVANCE_BACKWARD_HPP_INCLUDED
...
#   define RTIBOOST_MPL_PREPROCESSED_HEADER advance_backward.hpp
...
// forward declaration
template< RTIBOOST_MPL_AUX_NTTP_DECL(long, N) > struct advance_backward;

#   define RTIBOOST_PP_ITERATION_PARAMS_1 \
    (3,(0, RTIBOOST_MPL_LIMIT_UNROLLING, <rtiboost/mpl/aux_/advance_backward.hpp>))
...
struct advance_backward
{
    template< typename Iterator > struct apply
    {
        typedef typename apply_wrap1<
              advance_backward<RTIBOOST_MPL_LIMIT_UNROLLING>
            , Iterator
            >::type chunk_result_;
...
#endif // RTIBOOST_MPL_AUX778076_ADVANCE_BACKWARD_HPP_INCLUDED
...
template<>
struct advance_backward< RTIBOOST_PP_FRAME_ITERATION(1) >
{
    template< typename Iterator > struct apply
    {
...
#   define RTIBOOST_PP_ITERATION_PARAMS_2 \
    (3,(1, RTIBOOST_PP_FRAME_ITERATION(1), <rtiboost/mpl/aux_/advance_backward.hpp>))
#   include RTIBOOST_PP_ITERATE()
#endif

        typedef RTIBOOST_PP_CAT(iter,RTIBOOST_PP_FRAME_ITERATION(1)) type;
    };
...
#   define RTIBOOST_AUX778076_ITER_1 RTIBOOST_PP_CAT(iter,RTIBOOST_PP_FRAME_ITERATION(2))
        ...
        typedef typename prior<RTIBOOST_AUX778076_ITER_0>::type RTIBOOST_AUX778076_ITER_1;
