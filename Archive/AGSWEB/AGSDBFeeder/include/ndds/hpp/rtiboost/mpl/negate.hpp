...
#ifndef RTIBOOST_MPL_NEGATE_HPP_INCLUDED
#define RTIBOOST_MPL_NEGATE_HPP_INCLUDED
...
#endif
{
    RTIBOOST_MPL_AUX_LAMBDA_SUPPORT(1, negate, (N))
};

RTIBOOST_MPL_AUX_NA_SPEC(1, negate)
...
{
    RTIBOOST_STATIC_CONSTANT(T, value = -n);
...
template<>
struct negate_impl<rtiboost_integral_c_tag>
{
#if defined(RTIBOOST_MPL_CFG_NO_NESTED_VALUE_ARITHMETIC)
...
#endif // RTIBOOST_MPL_NEGATE_HPP_INCLUDED
