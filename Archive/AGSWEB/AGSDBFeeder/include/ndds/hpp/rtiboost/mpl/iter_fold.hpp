...
#ifndef RTIBOOST_MPL_ITER_FOLD_HPP_INCLUDED
#define RTIBOOST_MPL_ITER_FOLD_HPP_INCLUDED
...
#include <rtiboost/mpl/aux_/iter_fold_impl.hpp>
...
struct iter_fold
{
    ...
    RTIBOOST_MPL_AUX_LAMBDA_SUPPORT(3,iter_fold,(Sequence,State,ForwardOp))
};

RTIBOOST_MPL_AUX_NA_SPEC(3, iter_fold)

}}

#endif // RTIBOOST_MPL_ITER_FOLD_HPP_INCLUDED
