...
#ifndef RTIBOOST_MPL_AUX_REVERSE_FOLD_IMPL_HPP_INCLUDED
#define RTIBOOST_MPL_AUX_REVERSE_FOLD_IMPL_HPP_INCLUDED
...
#   define RTIBOOST_MPL_PREPROCESSED_HEADER reverse_fold_impl.hpp
#   include <rtiboost/mpl/aux_/include_preprocessed.hpp>

#else

#   define RTIBOOST_AUX778076_FOLD_IMPL_OP(iter) typename deref<iter>::type
#   define RTIBOOST_AUX778076_FOLD_IMPL_NAME_PREFIX reverse_fold
#   include <rtiboost/mpl/aux_/reverse_fold_impl_body.hpp>

#endif // RTIBOOST_MPL_CFG_NO_PREPROCESSED_HEADERS
#endif // RTIBOOST_MPL_AUX_REVERSE_FOLD_IMPL_HPP_INCLUDED
