...
#ifndef RTIBOOST_TYPEOF_INT_ENCODING_HPP_INCLUDED
#define RTIBOOST_TYPEOF_INT_ENCODING_HPP_INCLUDED
...
namespace rtiboost { namespace type_of {
    ...
    struct pack
    {
        RTIBOOST_STATIC_CONSTANT(std::size_t , value=((n + 1) * 2 + (Overflow ? 1 : 0)));
    };

    template<std::size_t m>
    struct unpack
    {
        RTIBOOST_STATIC_CONSTANT(std::size_t, value = (m / 2) - 1);
        RTIBOOST_STATIC_CONSTANT(std::size_t, overflow = (m % 2 == 1));
    };
    ...
    struct encode_size_t : push_back<
        V,
        rtiboost::mpl::size_t<pack<n, false>::value>
    >
    {};
    ...
    struct encode_size_t<V, n, true> : push_back<typename push_back<
        V,
        rtiboost::mpl::size_t<pack<n % 0x3ffffffe, true>::value> >::type,
        rtiboost::mpl::size_t<n / 0x3ffffffe>
    >
    {};
    ...
    {
        RTIBOOST_STATIC_CONSTANT(std::size_t,m = Iter::type::value);

        RTIBOOST_STATIC_CONSTANT(std::size_t,value = (std::size_t)m * 0x3ffffffe + n);
    ...
    struct decode_integral
    {
        ...
        RTIBOOST_STATIC_CONSTANT(std::size_t,n = unpack<m>::value);

        RTIBOOST_STATIC_CONSTANT(std::size_t,overflow = unpack<m>::overflow);
...
#endif//RTIBOOST_TYPEOF_INT_ENCODING_HPP_INCLUDED
