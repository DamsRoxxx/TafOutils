...
typedef detail::CollectionType CollectionType;
typedef detail::SequenceType SequenceType;
typedef detail::StringType StringType;
typedef detail::WStringType WStringType;
typedef detail::ArrayType ArrayType;
