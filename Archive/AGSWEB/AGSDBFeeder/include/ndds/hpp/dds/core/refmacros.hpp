...
#define OMG_DDS_REF_TYPE_NODC(TYPE, BASE, DELEGATE)                        \
    ...
    TYPE& operator=(dds::core::null_type) \
    { \
        BASE< DELEGATE >::operator =(dds::core::null); \
        return *this; \
    }
...
#define OMG_DDS_REF_TYPE_T(TYPE, BASE, T_PARAM, DELEGATE) \
    ...
    TYPE& operator=(dds::core::null_type) \
    { \
        BASE<T_PARAM, DELEGATE >::operator =(dds::core::null); \
        return *this; \
    }
...
#define OMG_DDS_BASIC_REF_TYPE(TYPE, BASE, DELEGATE)      \
    private: \
    TYPE(); \
    OMG_DDS_BASIC_REF_TYPE_NODC(TYPE, BASE, DELEGATE)

#define OMG_DDS_BASIC_REF_TYPE_NODC(TYPE, BASE, DELEGATE)      \
    public: \
      TYPE( \
          typename dds::core::smart_ptr_traits<DELEGATE>::ref_type delegate_ref) \
              : BASE<DELEGATE>(delegate_ref) \
      { \
          if (this->delegate()) { \
