...
#ifndef RTIBOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
#define RTIBOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
...
template< typename T > struct msvc_eti_base
    : T
{
#if RTIBOOST_WORKAROUND(RTIBOOST_MPL_CFG_GCC, RTIBOOST_TESTED_AT(0x0304))
    msvc_eti_base();
#endif
    typedef T type;
};
...
#endif // RTIBOOST_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
