...
// Preprocessed version of "rtiboost/mpl/unpack_args.hpp" header
...
template< RTIBOOST_MPL_AUX_NTTP_DECL(int, size) > struct unpack_args_impl
{
...
RTIBOOST_MPL_AUX_PASS_THROUGH_LAMBDA_SPEC(1, unpack_args)
