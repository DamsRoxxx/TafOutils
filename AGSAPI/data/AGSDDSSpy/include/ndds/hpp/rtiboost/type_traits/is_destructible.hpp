...
#ifndef RTIBOOST_TT_IS_DESTRUCTIBLE_HPP_INCLUDED
#define RTIBOOST_TT_IS_DESTRUCTIBLE_HPP_INCLUDED
...
namespace rtiboost{
   ...
   namespace detail{
      ...
      {
         template<typename T, typename = decltype(rtiboost::declval<T&>().~T())>
   ...
   template <class T> struct is_destructible : public integral_constant<bool, sizeof(detail::is_destructible_imp::test<T>(0)) == sizeof(rtiboost::type_traits::yes_type)>{};
...
#endif // RTIBOOST_TT_IS_DESTRUCTIBLE_HPP_INCLUDED
