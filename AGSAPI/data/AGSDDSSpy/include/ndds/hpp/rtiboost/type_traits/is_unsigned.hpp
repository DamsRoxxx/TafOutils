...
struct is_unsigned
{
   typedef ::rtiboost::detail::is_unsigned_select_helper< ::rtiboost::is_integral<T>::value || ::rtiboost::is_enum<T>::value > selector;
...
template <class T> struct is_unsigned : public integral_constant<bool, rtiboost::detail::is_unsigned<T>::value> {};
...
template <> struct is_unsigned< ::rtiboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const ::rtiboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<volatile ::rtiboost::ulong_long_type> : public true_type{};
template <> struct is_unsigned<const volatile ::rtiboost::ulong_long_type> : public true_type{};

template <> struct is_unsigned< ::rtiboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const ::rtiboost::long_long_type> : public false_type{};
template <> struct is_unsigned<volatile ::rtiboost::long_long_type> : public false_type{};
template <> struct is_unsigned<const volatile ::rtiboost::long_long_type> : public false_type{};
#endif
#if defined(CHAR_MIN) 
#if CHAR_MIN == 0
...
#endif
#endif
#if !defined(RTIBOOST_NO_INTRINSIC_WCHAR_T) && defined(WCHAR_MIN)
#if WCHAR_MIN == 0
