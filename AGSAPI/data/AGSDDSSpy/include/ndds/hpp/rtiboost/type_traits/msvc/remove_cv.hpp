...
#ifndef RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_CV_HOLT_2004_0901
#define RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_CV_HOLT_2004_0901
...
namespace rtiboost {
    ...
    template<typename T>
    struct remove_cv {
        typedef rtiboost::detail::remove_cv_impl_typeof<
        ...
        typedef typename 
            ...
            >::type
        type;
        RTIBOOST_MPL_AUX_LAMBDA_SUPPORT(1,remove_cv,T)
    };
}//namespace rtiboost

#endif //RTIBOOST_TYPE_TRAITS_MSVC_REMOVE_CV_HOLT_2004_0901
