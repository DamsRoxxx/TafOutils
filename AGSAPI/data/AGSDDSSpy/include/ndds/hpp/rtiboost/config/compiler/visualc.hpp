...
// C++11 features supported by VC++ 14 (aka 2015) // Modified by RTI
// from boost 1.58.0
...
#   elif _MSC_VER < 2000  
#     define RTIBOOST_COMPILER_VERSION evc14
#   else
#      if defined(RTIBOOST_ASSERT_CONFIG)
#         error "Unknown EVC++ compiler version - please run the configure tests and report the results"
#      else
...
//
// Modified by RTI: remove version check. RTI tests already validate boost for
// new versions of Visual Studio.
//
//#if (_MSC_VER > 1900)
//#  if defined(RTIBOOST_ASSERT_CONFIG)
