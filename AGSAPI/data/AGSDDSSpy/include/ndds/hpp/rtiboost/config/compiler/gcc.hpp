...
//
#define RTIBOOST_GCC_VERSION (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#if !defined(__CUDACC__)
#define RTIBOOST_GCC RTIBOOST_GCC_VERSION
#endif

#if defined(__GXX_EXPERIMENTAL_CXX0X__) || (__cplusplus >= 201103L)
#  define RTIBOOST_GCC_CXX11
#endif
...
#if RTIBOOST_GCC_VERSION >= 30400
#define RTIBOOST_HAS_PRAGMA_ONCE
#endif

#if RTIBOOST_GCC_VERSION < 40400
...
#if defined(__SIZEOF_INT128__) && !defined(RTIBOOST_NVCC_CXX03)
...
#include <stddef.h>
#endif
#if defined(_GLIBCXX_USE_FLOAT128) && !defined(__STRICT_ANSI__) && !defined(RTIBOOST_NVCC_CXX03)
# define RTIBOOST_HAS_FLOAT128
#endif

// C++0x features in 4.3.n and later
//
#if (RTIBOOST_GCC_VERSION >= 40300) && defined(RTIBOOST_GCC_CXX11)
...
//
#if (RTIBOOST_GCC_VERSION < 40400) || !defined(RTIBOOST_GCC_CXX11)
...
#if RTIBOOST_GCC_VERSION < 40500
#  define RTIBOOST_NO_SFINAE_EXPR
#endif

// GCC 4.5 forbids declaration of defaulted functions in private or protected sections
#if __GNUC__ < 4 || (__GNUC__ == 4 && __GNUC_MINOR__ == 5) || !defined(RTIBOOST_GCC_CXX11)
#  define RTIBOOST_NO_CXX11_NON_PUBLIC_DEFAULTED_FUNCTIONS
#endif

// C++0x features in 4.5.0 and later
//
#if (RTIBOOST_GCC_VERSION < 40500) || !defined(RTIBOOST_GCC_CXX11)
...
//
#if (RTIBOOST_GCC_VERSION < 40501) || !defined(RTIBOOST_GCC_CXX11)
...
//
#if (RTIBOOST_GCC_VERSION < 40600) || !defined(RTIBOOST_GCC_CXX11)
...
//
#if (RTIBOOST_GCC_VERSION < 40700) || !defined(RTIBOOST_GCC_CXX11)
...
//
#if (RTIBOOST_GCC_VERSION < 40800) || !defined(RTIBOOST_GCC_CXX11)
#  define RTIBOOST_NO_CXX11_ALIGNAS
#endif

// C++0x features in 4.8.1 and later
//
#if (RTIBOOST_GCC_VERSION < 40801) || !defined(RTIBOOST_GCC_CXX11)
...
//
#if (RTIBOOST_GCC_VERSION < 40900) || (__cplusplus < 201300)
...
#  if !((RTIBOOST_GCC_VERSION >= 40801) && (RTIBOOST_GCC_VERSION < 40900) && defined(RTIBOOST_GCC_CXX11))
...
#if (RTIBOOST_GCC_VERSION< 30300)
#  error "Compiler not configured - please reconfigure"
#endif
//
// last known and checked version is 4.9:
#if (RTIBOOST_GCC_VERSION > 40900)
